          ...
          {step === 'plans' && !isPro && (
            <div className="space-y-4">
                ...
                {proPlans.map(plan => (
                  <div key={plan.id} className={`card p-4 flex items-center gap-4 ${plan.popular ? 'border-violet-500/50 ring-1 ring-violet-500/20' : ''}`}>
                    <div className="flex-1">
                      ...
                      <div className="text-[10px] text-green-400 font-mono mt-1">✓ Pix · Cartão · Boleto · Renovação automática · Cancele quando quiser</div>
                    </div>
                    <button
              ...
              <div className="flex items-center justify-center gap-2 text-[10px] text-slate-500 font-mono">
                <span>🔒</span>
                <span>Assinatura recorrente · Pix · Cartão · Boleto · Cancele quando quiser</span>
              </div>
