...
export const EXERCISES: Exercise[] = [
  ...
  intervalLeap('iv-int-min10', 'intermediate', 'min10', 60),
  intervalLeap('iv-int-maj10', 'intermediate', 'maj10', 60),
  intervalLeap('iv-int-p11', 'intermediate', 'p11', 60),
  ...
  intervalLeap('iv-adv-aug11', 'advanced', 'aug11', 60),
  intervalLeap('iv-adv-p12', 'advanced', 'p12', 60),
  intervalLeap('iv-adv-min13', 'advanced', 'min13', 60),
  intervalLeap('iv-adv-maj13', 'advanced', 'maj13', 60),
